...
public class equipoServiceImp implements equipoService {
    ...
    public List<equipoResponseDTO> getAllEquipos() {
        List<equipoModel> equipos = equipoDao.findAll();
        ...
        return equipos.stream()
                .map(equipo -> {
                    ...
                    if (equipo.getTipo() != null) {
                        dto.setIdTipo(equipo.getTipo().getIdTipo());
                        dto.setTipoNombre(equipo.getTipo().getNombre());
                    } else {
                        dto.setIdTipo(null);
                        dto.setTipoNombre("Sin tipo asignado");
                    }
