...
-- Volcando estructura de base de datos para moduloinventario
CREATE DATABASE IF NOT EXISTS `moduloinventario` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `moduloinventario`;

-- Volcando estructura para tabla moduloinventario.atencion
CREATE TABLE IF NOT EXISTS `atencion` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `_03fechaatencion` date NOT NULL,
  `_04horaatencion` varchar(255) DEFAULT NULL,
  `_05observaciones` varchar(255) DEFAULT NULL,
  `_02solucion` varchar(255) DEFAULT NULL,
  `_01idsolicitud` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKicv9srp1wfh5no0tk28xllmhd` (`_01idsolicitud`),
  CONSTRAINT `FKicv9srp1wfh5no0tk28xllmhd` FOREIGN KEY (`_01idsolicitud`) REFERENCES `solicitud_atencion` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla moduloinventario.atencion: ~0 rows (aproximadamente)
INSERT INTO `atencion` (`id`, `_03fechaatencion`, `_04horaatencion`, `_05observaciones`, `_02solucion`, `_01idsolicitud`) VALUES
	(1, '2025-02-11', '10:00', 'cable antiguo roto', 'cambio de cable', 6);
...
-- Volcando datos para la tabla moduloinventario.equipo: ~48 rows (aproximadamente)
INSERT INTO `equipo` (`id`, `_01codigo`, `_06detalle`, `_02mac_serie`, `_03marca`, `_05modelo`, `_04id_tipo`) VALUES
	...
	(53, '2222222', 'color negro', 'SJHFH874', 'SONY', 'A', 2),
	(54, '0101010', 'color negro', 'QJJHWI12', 'LG', 'B', 2);
...
-- Volcando datos para la tabla moduloinventario.pertenece: ~50 rows (aproximadamente)
INSERT INTO `pertenece` (`id`, `_01cif`, `_05estado`, `_03fechaadd`, `_04fechadel`, `_02idequipo`) VALUES
	...
	(2, 23, 'activo', '2025-01-30', '2025-12-30', 8),
	...
	(38, 23110199500, 'activo', '2025-01-08', '2025-02-08', 45),
	...
	(45, 3333333, 'INACTIVO', '2025-01-08', '2025-02-08', 53),
	(46, 555555, 'INACTIVO', '2025-02-09', '2025-03-09', 53),
	(47, 6666666, 'INACTIVO', '2025-05-01', '2025-05-08', 53),
	(48, 7777777, 'INACTIVO', '2025-06-01', '2025-06-03', 53),
	(49, 888888, 'activo', '2025-06-04', '2025-06-08', 53),
	(50, 12345, 'INACTIVO', '2025-01-15', '2025-06-08', 54),
	(51, 54321, 'activo', '2025-03-20', '2025-06-08', 54);
...
-- Volcando estructura para tabla moduloinventario.solicitud_atencion
CREATE TABLE IF NOT EXISTS `solicitud_atencion` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `_05error` varchar(255) NOT NULL,
  `_04especificacion` varchar(255) DEFAULT NULL,
  `_06estado` int NOT NULL,
  `_02fechasolicitud` date NOT NULL,
  `_03horasolicitud` varchar(255) DEFAULT NULL,
  `_01idequipo` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FKnya7u73jlsuveuqr5hbpqqjm9` (`_01idequipo`),
  CONSTRAINT `FKnya7u73jlsuveuqr5hbpqqjm9` FOREIGN KEY (`_01idequipo`) REFERENCES `equipo` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla moduloinventario.solicitud_atencion: ~7 rows (aproximadamente)
INSERT INTO `solicitud_atencion` (`id`, `_05error`, `_04especificacion`, `_06estado`, `_02fechasolicitud`, `_03horasolicitud`, `_01idequipo`) VALUES
	(1, 'no prende', 'fallo en laptop', 0, '2025-06-08', '8:00', 30),
	(2, 'sin conexion', 'revisar', 0, '2025-06-08', '9:00', 53),
	(3, 'sin internet', 'revisar', 0, '2025-06-08', '12:00', 53),
	(4, 'sin internet', 'revisar conexion', 0, '2025-06-08', '14:00', 53),
	(5, 'string', 'string', 0, '2025-06-08', '13:00', 53),
	(6, 'no carga', 'revisar cable', 1, '2025-02-10', '8:45', 54),
	(7, 'no prende', 'revisar pantalla', 0, '2025-04-05', '9:45', 54);
